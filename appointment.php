            ...
            if(isset($_POST['submit_book_appointment_form']) && $_SERVER['REQUEST_METHOD'] === 'POST')
            {
                ...
                try
                {
					...
					if($client_count > 0)
					{
                        ...
                        $stmtClient = $con->prepare("UPDATE clients SET phone_number = ? WHERE client_id = '".$_SESSION['client_id']."' ");
                        $stmtClient->execute(array($client_phone_number));
                        ...
                        foreach($selected_services as $service){
                            ...
                            $stmt->execute(array($selected_employee));
                            $row = $stmt->fetch();
                            ...
                            $rows = $stmt->fetchAll();
                                ...
                                foreach($rows as $row){
                                    ...
                                    $mail->Body    = '
                                          ...
                                          Good day!<br><br>
                                         <div style="background-color:#c0db5c;width:500px;margin:auto;color:#000;font-size:24px;padding:20px 10px;">Thank you for your reservation 
                                         <br>
                                         Hair Style: '.$service_name.'
                                         <br>
                                         Price: '.$service_price.'
                                         <br>
                                         Employee: '.$employee.'
                                         ...
                                         <br>
                                         <p>
                                         Kindly use our online payment in order to continue your reservation, it will be automatically canceled your appointment if the payment doesnt receive after 30 minutes.
                                         <br>
                                        Thank you
                                         </p>
			...
			<div class="client_details_div tab_reservation" id="client_tab">
                ...
                <div>
                    <div class="form-group colum-row row">
                        <div class="col-sm-6">
                            <input type="text" name="client_first_name" id="client_first_name" class="form-control" value="<?php echo $row['first_name'] ?>" placeholder="First Name">
							<span class = "invalid-feedback">This field is required</span>
                        </div>
                        <div class="col-sm-6">
                            <input type="text" name="client_last_name" id="client_last_name" class="form-control" value="<?php echo $row['last_name'] ?>" placeholder="Last Name">
							<span class = "invalid-feedback">This field is required</span>
                        </div>
                        <div class="col-sm-6">
                            <input type="email" name="client_email" id="client_email" class="form-control" value="<?php echo $row['client_email'] ?>" placeholder="E-mail">
