...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2022 at 03:00 PM
...
CREATE TABLE `appointments` (
  ...
  `end_time_expected` datetime NOT NULL DEFAULT current_timestamp(),
...
INSERT INTO `appointments` (`appointment_id`, `date_created`, `client_id`, `employee_id`, `start_time`, `end_time_expected`, `canceled`, `cancellation_reason`, `proof`) VALUES
(23, '2022-12-15 04:21:00', 18, 2, '2022-12-19 09:45:00', '2022-12-19 10:00:00', 1, 'cancel', ''),
(24, '2022-12-15 04:23:00', 18, 2, '2022-12-24 09:30:00', '2022-12-24 09:45:00', 0, NULL, 'images (2).png'),
(25, '2022-12-15 04:30:00', 18, 3, '2022-12-19 09:30:00', '2022-12-19 09:50:00', 0, NULL, ''),
(26, '2022-12-15 04:34:00', 18, 2, '2022-12-24 10:00:00', '2022-12-24 10:10:00', 0, NULL, ''),
(27, '2022-12-15 04:35:00', 18, 2, '2022-12-24 10:00:00', '2022-12-24 10:10:00', 0, NULL, ''),
(28, '2022-12-15 04:39:00', 18, 2, '2022-12-24 10:00:00', '2022-12-24 10:10:00', 0, NULL, ''),
(29, '2022-12-15 04:40:00', 18, 2, '2022-12-24 10:00:00', '2022-12-24 10:10:00', 0, NULL, '');
...
INSERT INTO `clients` (`client_id`, `first_name`, `last_name`, `phone_number`, `client_email`, `username`, `password`) VALUES
...
(13, 'bryan', 'starl', '0912345678', 'staff@email.com', '', ''),
(18, 'sorar', 'sorar', '0912345678', 'sorar384@gmail.com', 'sorar384@gmail.com', '44c9052d2a658403e3b88e4100e3ba3696feb7c4');
...
--
ALTER TABLE `appointments`
  MODIFY `appointment_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
