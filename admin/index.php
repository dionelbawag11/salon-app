                                    ...
                                    else
                                    {
                                        ...
                                        foreach($rows as $row)
                                        {
                                            echo "<tr>";
                                                ...
                                                echo "</td>";
                                                echo "<td>";
                                                    $stmtEmployees = $con->prepare("SELECT first_name,last_name, a.proof AS proofa
                                                	...
                                                	$cancel_data = "cancel_appointment_".$row["appointment_id"];
                                               		...
                                               		<ul class="list-inline m-0">
                                                        ...
                                                        <li class="list-inline-item" data-toggle="tooltip">
                                                            <button class="btn btn-primary btn-sm rounded-0 proof" type="button" value="<?php echo $row['appointment_id']; ?>" data-toggle="modal" data-target="#proofmodal" data-placement="top">
                                                                Proof
                                                            </button>
                                                        </li>
                                                    </ul>
...
<div class="modal fade" id="proofmodal" tabindex="-1" role="dialog" aria-labelledby="proof" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Proof Gcash</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="showproof"></div>
            </div>
            <div class="modal-footer">
