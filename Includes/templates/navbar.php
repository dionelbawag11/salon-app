                ...
                <div class="d-flex menu-wrap align-items-center main-menu-container">
                    <div class="mainmenu" id="mainmenu">
                        <ul class="nav">
                            ...
                            <li><a href="myappointment.php">Appointment</a></li>
                        </ul>
                    </div>
                    <div class="header-btn" style="margin-left:10px">
                        ...
                        <?php }else{ ?>
                            <a href="login.php" class="menu-btn">Make Appointment</a>
                        <?php } ?>
                        
                    </div>
                    <div class="header-btn" style="margin-left:10px">
                        <?php if (isset($_SESSION['client_id'])) { ?>
                            <a href="logout.php" class="text-white" style="float: right;"><i class="fas fa-sign-out"></i></a>
                        <?php } ?>
                    </div>
                </div>
